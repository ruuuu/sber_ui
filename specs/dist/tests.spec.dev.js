...
it.only('Создание НП-10 значный', function _callee3() {
  var email, password, inn, innCell, innCellText, masInn, index, _innCell, _innCellText, cellInn, cellInnText, cellStatus, cellStatusText, cellActivity, cellActivityText;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          inn = '5074018058'; // Рандомно выбирать потом из массива 10- значных
        ...
        case 13:
          innCell = _context3.sent;
          _context3.next = 16;
          return regeneratorRuntime.awrap((0, _index.app)().locatorPage().getElement(page, innCell));

        case 16:
          innCellText = _context3.sent;
          // значение инн в ячейке
          masInn = ['2465102947', '3444197900', '2466126411', '1102069910', '2636208110'];
        ...
        case 18:
          ...
          // если такой инн уже есть в системе
        ...
        case 27:
          _innCell = _context3.sent;
          _context3.next = 30;
          return regeneratorRuntime.awrap((0, _index.app)().locatorPage().getElement(page, _innCell));

        case 30:
          _innCellText = _context3.sent;
          _context3.next = 18;
          break;
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 5:
          ...
          inn = ''; // Рандомно выбирать потом из массива 12- значных
...
it('Поиск по ИНН на вкладке НП', function _callee5() {
...
it('Поиск по ИНН на вкладке Запросы', function _callee6() {
  var arrayInn, index, inn, email, password, innCell, innCellText;
...
it('Фильтр по ИНН на вкладке НП', function _callee7() {
  var arrayInn, index, inn, email, password, innCell, innCellText;
...
it('Фильтр по ИНН на вкладке Запросы', function _callee8() {
  var arrayInn, index, inn, email, password, innCell, innCellText;
