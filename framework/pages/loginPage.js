...
const LoginPage = function(){ 
  ...
  this.getAllInn = async function (){  
    ...
    const rr = await supertest('https://sber.cprr-dev.weintegrator.com')
      .post('/api/v0/vst-oauth2/oauth/token') // путь
    ...
    const r = await supertest('https://sber.cprr-dev.weintegrator.com')
        .get('/api/v0/tpf-bank/taxpayers') // метод гет   
